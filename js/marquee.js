Marquee3k.pauseAll(), $(".a0").mouseenter(function () {
    for (Marquee3k.play(0), i = 0; 23 >= i; i++)
        if (0 != i)
            for (l = document.querySelectorAll(".a" + i).length, j = 0; j < l; j++) document.querySelectorAll(".a" + i)[j].style.filter = "blur(13px)"
}), $(".a0").mouseleave(function () {
    for (Marquee3k.pause(0), i = 0; 23 >= i; i++)
        for (l = document.querySelectorAll(".a" + i).length, j = 0; j < l; j++) document.querySelectorAll(".a" + i)[j].style.filter = "blur(0px)"
